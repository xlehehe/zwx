package com.zwx.library.banner;
...
import com.zwx.library.banner.transformer.CoverModeTransformer;
import com.zwx.library.banner.transformer.ScaleYTransformer;
import com.zwx.library.banner.view.MyViewPager;
...
public class MZBanner<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.drawable.ic_banner_unselect,R.drawable.ic_banner_selected};
    ...
    public MZBanner(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public MZBanner(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void readAttrs(Context context,AttributeSet attrs){
        TypedArray typedArray = context.obtainStyledAttributes(attrs,R.styleable.MZBanner);
        mIsOpenMZEffect = typedArray.getBoolean(R.styleable.MZBanner_open_mz_mode,true);
        mIsMiddlePageCover = typedArray.getBoolean(R.styleable.MZBanner_middle_page_cover,true);
        mIsCanLoop = typedArray.getBoolean(R.styleable.MZBanner_canLoop,true);
        mIndicatorAlign = typedArray.getInt(R.styleable.MZBanner_indicatorAlign, IndicatorAlign.CENTER.ordinal());
        mIndicatorPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.MZBanner_indicatorPaddingLeft,0);
        mIndicatorPaddingRight = typedArray.getDimensionPixelSize(R.styleable.MZBanner_indicatorPaddingRight,0);
        mIndicatorPaddingTop = typedArray.getDimensionPixelSize(R.styleable.MZBanner_indicatorPaddingTop,0);
        mIndicatorPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.MZBanner_indicatorPaddingBottom,0);
        typedArray.recycle();
    }
    ...
    private void init(){
      View view = null;
        if(mIsOpenMZEffect){
            view = LayoutInflater.from(getContext()).inflate(R.layout.layout_mz_banner_effect,this,true);
        }else{
            view = LayoutInflater.from(getContext()).inflate(R.layout.layout_mz_banner_normal,this,true);
        }
      mIndicatorContainer = (LinearLayout) view.findViewById(R.id.banner_indicator_container);
      mViewPager = (MyViewPager) view.findViewById(R.id.mzbanner_vp);
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link MZBanner {@link #setPages(List, MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
