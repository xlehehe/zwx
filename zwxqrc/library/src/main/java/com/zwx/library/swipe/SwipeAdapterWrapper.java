...
public class SwipeAdapterWrapper extends RecyclerAdapterWithHF {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final SwipeMenuLayout swipeMenuLayout = (SwipeMenuLayout) mInflater.inflate(R.layout.layout_recycler_swipe_view_item, parent, false);
