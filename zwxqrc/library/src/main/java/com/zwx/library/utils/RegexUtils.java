...
import com.zwx.library.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    public static boolean isBussTimeExact(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_BUSS_TIME, input);
    }
