...
import com.zwx.library.banner.listener.OnBannerClickListener;
import com.zwx.library.banner.listener.OnBannerListener;
import com.zwx.library.banner.loader.ImageLoaderInterface;
import com.zwx.library.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.ic_banner_selected;
    private int mIndicatorUnselectedResId = R.drawable.ic_banner_unselect;
...
//        bannerDefaultImage.setImageResource(bannerBackgroundImage);
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.ic_banner_selected);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.ic_banner_unselect);
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, 8);
            } else {
