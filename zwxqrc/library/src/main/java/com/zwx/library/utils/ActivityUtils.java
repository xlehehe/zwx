...
//        startActivity(intent, Utils.getTopActivityOrApp(), null);
     ...
     * Finish the activity.
     *
     * @param clz The activity class finish.
     * @param toClz The activity class.
     *  enterAnim A resource ID of the animation resource to use for the
     *                  incoming activity.
     *  exitAnim  A resource ID of the animation resource to use for the
     *                  outgoing activity.
     */
    public static void finishActivity(@NonNull final Class<? extends Activity> clz,
                                      @NonNull final Class<? extends Activity> toClz) {
        ...
        Context context = Utils.getTopActivityOrApp();
        startActivity(context, null, context.getPackageName(), toClz.getName(),
                getOptionsBundle(context, enterAnim, exitAnim));
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN && context instanceof Activity) {
            ((Activity) context).overridePendingTransition(enterAnim, exitAnim);
        }
