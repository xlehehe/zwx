...
import com.zwx.library.constant.TimeConstants;
...
public final class TimeUtils {
    ...
    public static final SimpleDateFormat DATE_FORMAT_DATETIME_DOT = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss");
    public static final SimpleDateFormat DATE_FORMAT_HOUR_MINETE_TIME = new SimpleDateFormat("HH:mm");

    public static final SimpleDateFormat DATEFORMATDATE = new SimpleDateFormat("yyyyMMddHHmmss");
    ...
    public static Date string2Date(final String time) {
        return string2Date(time, getDefaultFormat2());
    }


    public static Date string2DateYYYYMMDD(final String time) {
        return string2Date(time, getDefaultFormatyyyymmdd());
    }
    public static Date string2DateDot(final String time) {
        return string2Date(time, getDefaultFormatDot2());
    }

    public static Date stringDateDotYMDHMS(final String time) {
        return string2Date(time, getDefaultFormatDotYMDHMS());
    }

    public static Date stringDateYMDHMS(final String time) {
        return string2Date(time, getDefaultFormatYMDHMS());
    }
    public static Date string2HHDate(final String time) {
    ...
    private static SimpleDateFormat getDefaultFormatyyyymmdd() {
        SimpleDateFormat simpleDateFormat = SDF_THREAD_LOCAL.get();
        if (simpleDateFormat == null) {
    ...
    private static SimpleDateFormat getDefaultFormatDot2() {
        SimpleDateFormat simpleDateFormat = SDF_THREAD_LOCAL.get();
        if (simpleDateFormat == null) {
            simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd", Locale.getDefault());
            SDF_THREAD_LOCAL.set(simpleDateFormat);
    ...
    private static SimpleDateFormat getDefaultFormatDotYMDHMS() {
        SimpleDateFormat simpleDateFormat = SDF_THREAD_LOCAL.get();
        if (simpleDateFormat == null) {
            simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss", Locale.getDefault());
            SDF_THREAD_LOCAL.set(simpleDateFormat);
    ...
    private static SimpleDateFormat getDefaultFormatYMDHMS() {
        SimpleDateFormat simpleDateFormat = SDF_THREAD_LOCAL.get();
        if (simpleDateFormat == null) {
            simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault());
            SDF_THREAD_LOCAL.set(simpleDateFormat);
    ...
    private static long[] calculateDifference(long differentMilliSeconds) {
        ...
        LogUtils.v(String.format(Locale.CHINA, "different: %d ms, %d days, %d hours, %d minutes, %d seconds",
    ...
    public static SimpleDateFormat sdfDateOnly = new SimpleDateFormat(TimeUtils.DATE_FORMAT_DATEONLY);
    ...
    public static String MONTH_DAY_FORMAT = "MM.dd"; // 月.日
    public static SimpleDateFormat sdfMonthDay = new SimpleDateFormat(DateUtils.MONTH_DAY_FORMAT);
