...
import com.zwx.scan.app.feature.countanalysis.campaign.CampaignAnalysisFragment;
...
public class MemberAnalysisFragment extends BaseFragment {
    ...
    public static MemberAnalysisFragment getInstance(String params) {
        // Required empty public constructor
        MemberAnalysisFragment fragment = new MemberAnalysisFragment();
