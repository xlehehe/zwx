 ...
 * version: 1.0
 **/
public class PrizeGridImageAdapter extends
        RecyclerView.Adapter<PrizeGridImageAdapter.ViewHolder> {
    ...
    public PrizeGridImageAdapter(Context context, PrizeGridImageAdapter.onAddPicClickListener mOnAddPicClickListener) {
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        ...
                        LaohuPinTuanNextTwoActivity.selectList = list;
//                        EventBus.getDefault().post(new LhPtEventBus(list, list.get(position).getPath()));
                    }
                }
            });
    ...
    public void setOnItemClickListener(GridImageAdapter.OnItemClickListener listener) {
