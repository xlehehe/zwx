 ...
 * version: 1.0
 **/
public class CollectionTransferRecordActivity extends BaseActivity<FinancialAffairsContract.Presenter> implements FinancialAffairsContract.View,
    ...
    public CollectionTransferRecordAdapter listAdapter;

    protected List<CompWxpayTransfer> transferList = new ArrayList<>();
    @Override
    protected int getLayoutId() {
        return R.layout.activity_collection_transfer_record;
    }
...
//        tv_end_time.setText(TimeUtils.getReqDate(TimeUtils.getEndWeekDate()).replace("-","."));
    ...
    protected void initData() {
        ...
        listAdapter = new CollectionTransferRecordAdapter(this,transferList);

        listView.setAdapter(listAdapter);


        presenter.queryWxPayRecord(this,userId,salesTimeSta,salesTimesEnd,pageNumber,pageSize);
    }
    ...
    private  void setListener(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(CollectionTransferRecordActivity.this, CollectionTransferRecordDetailActivity.class);
                if (transferList != null && transferList.size() > 0) {
                    CompWxpayTransfer transfer = transferList.get(position);
                    intent.putExtra("transferId",transfer.getId()+"");
                    intent.putExtra("type",transfer.getType());
...
//                    orderList.clear();
                    if (salesTimeSta != null && !"".equals(salesTimeSta)) {
                        if (salesTimesEnd != null && !"".equals(salesTimesEnd)) {
                            pageNumber = 1;
                            transferList.clear();
                            presenter.queryWxPayRecord(CollectionTransferRecordActivity.this,userId,salesTimeSta,salesTimesEnd,pageNumber,pageSize);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
                ActivityUtils.finishActivity(CollectionTransferRecordActivity.class,
      ...
      /*      case R.id.btn_day:
                ...
                pageNumber = 1;
                transferList.clear();
//                presenter.selectTradeWithdrawalList(CollectionTransferRecordActivity.this, userId, salesTimeSta,salesTimesEnd,pageNumber, pageSize);
                break;*/
