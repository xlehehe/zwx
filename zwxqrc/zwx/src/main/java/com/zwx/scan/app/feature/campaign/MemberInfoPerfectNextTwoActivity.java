 ...
 * version: 1.0
 **/
public class MemberInfoPerfectNextTwoActivity extends BaseActivity<CampaignsContract.Presenter> implements CampaignsContract.View,View.OnClickListener, MemberInfoPerfectCouponNextFragment.ChanageToLayoutLisenter {
    ...
    protected static ArrayList<Coupon> couponList = new ArrayList<>();
    private List<ImageView> mDotsIV = new ArrayList<>();
    private MemberInfoPerfectCouponNextSettingFragment giveCouponNextFragment = new MemberInfoPerfectCouponNextSettingFragment();
    ...
    protected MemberInfoPerfectNextTwoActivity.CouponPagerAdapter pagerAdapter = null;
    protected MemberInfoPerfectNextTwoActivity.CouponSettPagerAdapter setPagerAdapter = null;
    ...
    protected int getLayoutId() {
        return R.layout.activity_member_info_perfect_next_two;
    }
...
//            btnSave.setText("返回");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_add_coupon:
                ...
                intent = new Intent(MemberInfoPerfectNextTwoActivity.this,CampaignCouponListActivity.class);
                intent.putExtra("nextTwoSelectCoupon","MEMBER_INFO");
                ActivityUtils.startActivityForResult(MemberInfoPerfectNextTwoActivity.this,intent,8888,R.anim.slide_in_right,R.anim.slide_out_left);
            ...
            case R.id.tv_right:
                ...
                isCopyCreate = "NO";
                isEditCampaign = "YES";
                MemberInfoPerfectNewActivity.compaignStatus = "NEW";
                if(MemberInfoPerfectNewActivity.campaign !=null){
                    MemberInfoPerfectNewActivity.campaign.setCampaignId(null);
                    MemberInfoPerfectNewActivity.campaign.setCampaignType("hy");
                    MemberInfoPerfectNewActivity.campaign.setCampaignName("");
                }
                ...
                Intent intent1 = new Intent(MemberInfoPerfectNextTwoActivity.this,MemberInfoPerfectNewActivity.class);

                intent1.putExtra("title",title);
                intent1.putExtra("isCopyCreate",isCopyCreate);
                intent1.putExtra("isEditCampaign",isEditCampaign);
                intent1.putExtra("campaignType","hy");
                intent1.putExtra("compaignStatus",  MemberInfoPerfectNewActivity.compaignStatus);
            ...
            case R.id.btn_pre: //上一步
                ...
                ActivityUtils.finishActivity(MemberInfoPerfectNextTwoActivity.class,
                        R.anim.slide_in_left, R.anim.slide_out_right);
                break;
            ...
            case R.id.btn_save:
                ...
                if(MemberInfoPerfectNewActivity.storeStr == null ){
                    MemberInfoPerfectNewActivity.storeStr = "";
                }
                if (!ButtonUtils.isFastDoubleClick(R.id.btn_save_and_public)) {   //处理防止点击多次
                    presenter.saveHyCampaignInfo(this,MemberInfoPerfectNewActivity.campaign,MemberInfoPerfectNewActivity.storeIdCampaignType,
                            MemberInfoPerfectNewActivity.storeStr,forwardCouponList,new ArrayList<>(),"",userId,compId,btnFlag);
                }
    ...
    private boolean check(){
        ...
        if("save".equals(btnFlag)){
            ...
            if(MemberInfoPerfectNewActivity.campaign !=null){
                String campaignName = MemberInfoPerfectNewActivity.campaign.getCampaignName();
                ...
                String startDate = MemberInfoPerfectNewActivity.campaign.getBeginDate();
                String endDate = MemberInfoPerfectNewActivity.campaign.getEndDate();
         ...
         /*   if(MemberInfoPerfectActivity.campaginGrant !=null){

                if("M".equals(MemberInfoPerfectActivity.grantType)){
                    String memberDay = MemberInfoPerfectActivity.campaginGrant.getMemberDay();
        ...
        public CouponPagerAdapter(FragmentManager fm, List<Coupon> couponList) {
            ...
            if(couponList !=null && couponList.size()>0){
                for (int i = 0;i<couponList.size();i++){
                    ...
                    Fragment fragment = MemberInfoPerfectCouponNextFragment.getInstance(coupon,i);
    ...
    protected void setViewPagerAdapter(){
        pagerAdapter  = new MemberInfoPerfectNextTwoActivity.CouponPagerAdapter(getSupportFragmentManager(),couponList);
        ...
        //底部优惠券设置内容
        setPagerAdapter = new MemberInfoPerfectNextTwoActivity.CouponSettPagerAdapter(getSupportFragmentManager(),couponList);
    ...
    public   class CouponSettPagerAdapter extends FragmentPagerAdapter {
        ...
        public CouponSettPagerAdapter(FragmentManager fm, List<Coupon> couponList) {
            ...
            if(couponList !=null && couponList.size()>0){
                for (int i = 0;i<couponList.size();i++){
                    Coupon coupon = couponList.get(i);
                    Fragment fragment = MemberInfoPerfectCouponNextSettingFragment.getInstance(coupon,i);
                    mFragmentList.add(fragment);
                }
            }
