 ...
 */
public class VerificationRecordFragment extends BaseFragment {
    ...
    public VerificationRecordFragment() {
    }
    public static VerificationRecordFragment getInstance(String params) {
        VerificationRecordFragment instance = new VerificationRecordFragment();
    ...
    protected int getlayoutId() {
        return R.layout.fragment_verification_record_report;
    }
    ...
    protected void initView() {
        ...
        }else if(params.equals("day")) {
            llLeft.setVisibility(View.GONE);
            llRight.setVisibility(View.GONE);
        }else if(params.equals("week")) {
            llLeft.setVisibility(View.GONE);
            llRight.setVisibility(View.GONE);
        }
//        initChart();
    ...
    public void initChart(){
        ...
        for (Map<String,Object> map:verificationTotalReport){
