 ...
 * author : lizhilong
 * time   : 2019/05/09
 * desc   : 交易提款 数据封装adapter
 * version: 1.0
 **/
public class TradeDrawingListAdapter extends BaseAdapter {


    private List<TOrderObject> data = new ArrayList<>();
    private LayoutInflater inflater;
    private Context context;
    public TradeDrawingListAdapter(Context context, List<TOrderObject> data) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
     ...
     /*   //商品金额
        ...
        //订单编号
        holder.tv_order_code.setText(order.getOrderCode() != null && !"".equals(order.getOrderCode())?String.valueOf(order.getOrderCode()):"—");
        ...
        String saleTime = order.getSalesTime();
        holder.tv_sale_time.setText(saleTime != null && !"".equals(saleTime)?saleTime:"—");




        //商品编码
        holder.tv_order_code.setText(order.getOrderCode() != null ?String.valueOf(order.getOrderCode()):"—");



        holder.tv_buy_phone.setText(order.getBuyCount()!= null && order.getBuyCount().intValue()>0?"x"+order.getBuyCount().intValue():"—");
