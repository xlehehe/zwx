...
import com.zwx.scan.app.widget.dialog.DateSelectorWheelView;
...
import com.zwx.scan.app.widget.dialog.holder.AlertDialogHolder;
import com.zwx.scan.app.widget.dialog.holder.SheetHolder;
...
//                buildMdLoading(bean);
            ...
            case DialogConfig.TYPE_CUSTOM_TRAN_ALERT:
                buildCustomTranAlert(bean);
                break;
            default:
                break;
...
*/
    ...
    //背景色透明
    private void buildCustomTranAlert(BuildBean bean) {
        AlertDialog.Builder builder = new AlertDialog.Builder(bean.mContext);
