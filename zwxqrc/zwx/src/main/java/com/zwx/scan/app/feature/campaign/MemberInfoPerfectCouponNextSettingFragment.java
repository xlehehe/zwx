 ...
 */
public class MemberInfoPerfectCouponNextSettingFragment extends BaseFragment<CampaignsContract.Presenter> implements CampaignsContract.View,View.OnClickListener {
    ...
    private MemberInfoPerfectNextTwoActivity activity =null;
    ...
    protected CouponMaterial material = null;
    ...
    public MemberInfoPerfectCouponNextSettingFragment() {
        // Required empty public constructor
    }

    public static MemberInfoPerfectCouponNextSettingFragment getInstance(Coupon coupon, int curPosition) {
        MemberInfoPerfectCouponNextSettingFragment fragment = new MemberInfoPerfectCouponNextSettingFragment();
    ...
    protected int getlayoutId() {
        return R.layout.fragment_member_info_perfect_next_setting;
    }
    ...
    public void onResume() {
        ...
        presenter.queryMemberInfoPerfectStoreList(getActivity(),userId,true,false);
    }
    ...
    protected void initView() {
        ...
        activity = (MemberInfoPerfectNextTwoActivity) getActivity();
        //设置高度
...
//        activity.setViewPager.setLayoutParams(linearParams);
        ...
        if(storeIdCouponType !=null && !"".equals(storeIdCouponType)){
            ...
            if("S".equals(MemberInfoPerfectNewActivity.compaignStatus)){
                tvStoreNames.setText(storeName);
            }else {
                storeIdCouponType = "A";
                tvStoreNames.setText("#全部店铺");
        ...
        if(MemberInfoPerfectNextTwoActivity.campaignCouponList!=null && MemberInfoPerfectNextTwoActivity.campaignCouponList.size()>0){
            for(int i =0;i<  MemberInfoPerfectNextTwoActivity.campaignCouponList.size();i++){
                CampaignCoupon campaignCoupon1 = MemberInfoPerfectNextTwoActivity.campaignCouponList.get(i);
...
//        activity.campaignCouponList.add(campaignCoupon);
    ...
    private void setCouponSelectStore(){
        if(MemberInfoPerfectNextTwoActivity.campaignCouponList!=null && MemberInfoPerfectNextTwoActivity.campaignCouponList.size()>0){
            for(CampaignCoupon campaignCoupon1 : MemberInfoPerfectNextTwoActivity.campaignCouponList){
    ...
    private void getDateData() {
        ...
        if (activity.campaignCouponList != null && activity.campaignCouponList.size() > 0) {
            for (int i=0;i< MemberInfoPerfectNextTwoActivity.campaignCouponList.size();i++) {
                CampaignCoupon campaignCoupon = MemberInfoPerfectNextTwoActivity.campaignCouponList.get(i);
                String couponId = String.valueOf(campaignCoupon.getCouponId());
                String couponId2 = String.valueOf(coupon.getId());
                if (couponId != null && couponId2 != null) {
                    String isSort2 = curPosition +"";
    ...
    private void setUpdateCoupon(){
        if(MemberInfoPerfectNextTwoActivity.couponList != null && MemberInfoPerfectNextTwoActivity.couponList.size()>0){
            for(int i=0;i<MemberInfoPerfectNextTwoActivity.couponList.size();i++){
                Coupon coupon1  = MemberInfoPerfectNextTwoActivity.couponList.get(i);
        ...
        switch (v.getId()) {
            case R.id.tv_select_shop:  //开始时间
                ...
                if(storeList != null && storeList.size()>0){
                    ...
                    presenter.queryMemberInfoPerfectStoreList(getActivity(),userId,false,false);
                }
                break;
            ...
            public void onClick(View v) {
                ...
                if(storeList!=null&& storeList.size()>0){
                    ...
                    if("YES".equals(isNextTwoAndThree)){
                        SPUtils.getInstance().put("storeIdGiveType","A");
                        SPUtils.getInstance().put("storeIdArrayGive",storeIdArr);
                        SPUtils.getInstance().put("storeNameArrayGive","#全部店铺");
                    }else {
                        SPUtils.getInstance().put("storeIdGiveType","A");
                        SPUtils.getInstance().put("storeIdArrayGive",storeIdArr);
                        SPUtils.getInstance().put("storeNameArrayGive","#全部店铺");
