 ...
 * version: 1.0
 **/
public class MemberConsumeListAdapter extends RecyclerView.Adapter {
    private List<MemberConsumeBean.MemberIT.MemberConsume> data = new ArrayList<>();
    private LayoutInflater inflater;
    private Context context;
    public MemberConsumeListAdapter(Context context, List<MemberConsumeBean.MemberIT.MemberConsume> data) {
        super();
