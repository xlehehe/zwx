 ...
 * @Package com.zwx.scan.app.widget.treeview.utils
 * @Description: TODO
...
public class TreeHelper {
    ...
    public static   List<Node> convertDatas3Nodes(List<Node> datas) throws IllegalAccessException, IllegalArgumentException {
	...
	public static  List<Node> getSortedNodes(List<Node> datas, int defaultExpandLevel) throws IllegalAccessException, IllegalArgumentException {
		...
		List<Node> nodes = convertDatas3Nodes(datas);	//转化后的所有节点
//		List<Node> nodes = datas;
