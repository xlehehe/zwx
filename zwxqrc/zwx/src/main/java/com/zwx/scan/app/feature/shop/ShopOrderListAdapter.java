...
import com.zwx.scan.app.feature.member.MemberConsumeDetailAdapter;
...
public class ShopOrderListAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {
    ...
    public ShopOrderListAdapter(Context context, List<TOrderObject> data) {
        super();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
      ...
      /*  if("1".equals(deType)){
        ...
        if("N".equals(status)){
            holder.iv_ziti.setImageResource(R.drawable.ic_duihuan_selected);
        }else if("Y".equals(status)){
            holder.iv_ziti.setImageResource(R.drawable.ic_duihuan_unselect);
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewHolder, int position) {
        View view = inflater.inflate(R.layout.item_shop_order_list, null);
    ...
    private class ChildViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChildViewHolder(View view) {
            ...
            tv_good_amt = (TextView) view.findViewById(R.id.tv_good_amt);
            tv_order_pay_amt = (TextView) view.findViewById(R.id.tv_order_pay_amt);
