...
import com.zwx.scan.app.feature.couponmanage.GiveCouponConsumeFragment;
...
import com.zwx.scan.app.feature.couponmanage.GiveCouponNextConsumeTwoFragment;
 ...
 */
public class CampaignLikeTwoCouponFragment extends BaseFragment implements View.OnClickListener{
    ...
    public CampaignLikeTwoCouponFragment() {
    }

    public static Fragment getInstance(Coupon coupon,String prizeName) {
        CampaignLikeTwoCouponFragment fragment = new CampaignLikeTwoCouponFragment();
    ...
    protected int getlayoutId() {
        return R.layout.fragment_give_coupon_consume;
    }
...
//                ivAvatar.setBackgroundResource(R.drawable.ic_coupon_other);
            ...
            case  R.id.ll_delete:
                ...
                if("条件一".equals(prizeName)){
                    ...
                    if(activity.couponList1 != null && activity.couponList1.size()>0){
                        ...
                        //同时删除优惠券列表页面
                        ((CampaignLikeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList1,prizeName);
                    ...
                    if(activity.couponList2 != null && activity.couponList2.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((CampaignLikeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList2,prizeName);
                    ...
                    if(activity.campaignCouponList3!= null && activity.campaignCouponList3.size()>0){
                        for(int i = 0 ;i<activity.campaignCouponList3.size();i++){
                            ...
                            if(campaignCoupon != null){
                                Long couponId =campaignCoupon.getId();
                                if(couponId != null){
                                    if(couponId == coupon.getId()){
                    ...
                    if(activity.couponList3 != null && activity.couponList3.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((CampaignLikeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList3,prizeName);
                    ...
                    if(activity.couponList4 != null && activity.couponList4.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((CampaignLikeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList4,prizeName);
    ...
    interface  ChanageLayoutLisenter{
