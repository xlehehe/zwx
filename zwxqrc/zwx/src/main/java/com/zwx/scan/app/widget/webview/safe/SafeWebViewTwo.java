package com.zwx.scan.app.widget.webview.safe;
 ...
 * version: 1.0
 **/
public class SafeWebViewTwo extends WebView {
    ...
    public SafeWebViewTwo(Context context) {
        this(context, null);
    }

    public SafeWebViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            ... 31 more
            ...
            LogUtils.e(TAG, "isWebViewPackageException", e);
...
//                    URLEncodedUtils.parse(new URI(url), null); // AccessibilityInjector.getAxsUrlParameterValue
                    ...
                    if ("bad parameter".equals(e.getMessage())) {
                        mIsAccessibilityEnabledOriginal = true;
                        setAccessibilityEnabled(false);
                        LogUtils.e(TAG, "fixedAccessibilityInjectorExceptionForOnPageFinished.url = " + url, e);
                    }
                }
            } catch (Throwable e) {
                if (BuildConfig.DEBUG) {
