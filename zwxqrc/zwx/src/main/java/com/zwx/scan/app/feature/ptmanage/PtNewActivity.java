...
public class PtNewActivity extends BaseActivity<PtContract.Presenter> implements PtContract.View,View.OnClickListener {
    ...
    public static CampaignGroupBuy campaignGroupBuy = new CampaignGroupBuy();
    ...
    protected int getLayoutId() {
        return R.layout.activity_pt_new;
    }
    ...
    protected void initView() {
        ...
        tvSelectStoreLeftTitle.setText(getResources().getString(R.string.select_join_pt_store));
        tvSelectStore.setText(getResources().getString(R.string.select_join_store_name));
        DaggerPtComponent.builder()
                .applicationComponent(AppContext.getApplicationComponent())
                .ptModule(new PtModule(this))
                .build()
...
//                tvStoreNames.setText("全部自营");
            ...
            if(storeName != null && !"".equals(storeName)){  //自定义选择多个店铺
                storeStr = storeId;
            }else {
...
//            tvStoreNames.refreshText();
        ...
        presenter.queryBrandAndStoreList(this,userId,true,true);
   ...
   /*     edtName.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    ...
                    KeyboardUtils.hideSoftInput(PtNewActivity.this,edtName);
                }
            }
        });*/
    }
...
//                campaign.setShareTitle("");
//                campaign.setShareDesc("");
                break;
            ...
            case R.id.tv_select_shop:  //开始时间
                ...
                if(storeList != null && storeList.size()>0){
                    ...
                    presenter.queryBrandAndStoreList(this,userId,false,true);
                }
            ...
            case R.id.btn_next: //下一步
                Intent intent = new Intent(PtNewActivity.this,PtNextTwoActivity.class);
                campaignName = edtName.getText().toString().trim();
                startDate = tvStartTime.getText().toString().trim();
                endDate = tvEndTime.getText().toString().trim();
                if(campaign == null){
    ...
    protected void  showPopView(Context context){
        ...
        rlSelfStore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(storeList!=null&& storeList.size()>0){
                    ...
                    tvStoreNames.setText(storeName);
                    SPUtils.getInstance().put("storeIdTypePtOne",storeIdCampaignType);
                    SPUtils.getInstance().put("storeIdArrayPtOne",storeIdArr);
                    SPUtils.getInstance().put("storeNameArrayPtOne",storeName);
        ...
        if(branList!=null&&branList.size()>0){
            ...
            SPUtils.getInstance().put("brandLogoPtOne",brandLogo);
...
//                        myAdapter.notifyDataSetChanged();
    ...
    protected void setBrandLogo(){
        ...
        Glide.with(PtNewActivity.this).load(brandLogo).apply(requestOptions).into(ivBrand);
    }
                                ...
                                if(isStartDate){
                                    ...
                                    if(!startDate.isEmpty() && !endDate.isEmpty()){
                                        ...
                                        if(end.before(start)){  //start 大于end时 返回true; 反之 小于等于返回false
                                            ToastUtils.showCustomShortHideCollect("结束时间不可小于开始时间！");
                                            tvEndTime.setText("");
                                        }else {
                                            pvCustomTime.dismiss();
                                        }
