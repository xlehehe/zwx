package com.zwx.scan.app.utils.log;
...
/**
 * 全局异常捕获
 * Created by lizhilong on 2018/11/7.
 */
...
//                Toast.makeText(mContext, "程序异常.", Toast.LENGTH_SHORT).show();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        /*    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                LogUtils.e( "日志目录"+Environment.getExternalStorageDirectory());
                String path = Environment.getExternalStorageDirectory() + "/acql/logs/app/";
