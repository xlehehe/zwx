            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        ...
                        if(StoreInfoManageActivity.photoList != null && StoreInfoManageActivity.photoList.size()>0){
                            String imageId = StoreInfoManageActivity.photoList.get(index);
                            if(imageId != null && imageId.length()>0){
                                activity.deleteImage(imageId,index);
                            }
                        }


                       /* if(activity.fileList != null && activity.fileList.size()>0){
                            for (int i = 0 ;i <activity.fileList.size();i++){
                                if(i == index){
                                    activity.fileList.remove(i);
                                    i--;
                                }
                            }
                        }*/
