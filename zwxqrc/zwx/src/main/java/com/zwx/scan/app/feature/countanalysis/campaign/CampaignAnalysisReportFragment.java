 ...
 */
public class CampaignAnalysisReportFragment extends BaseFragment {
    ...
    public CampaignAnalysisReportFragment() {
    }
    private String params1;
    private String params2;


    public static CampaignAnalysisReportFragment getInstance(String params1,String params2) {
        CampaignAnalysisReportFragment instance = new CampaignAnalysisReportFragment();
        instance.params1 = params1;
        instance.params2 = params2;
        return instance;
    }
    ...
    protected int getlayoutId() {
        return R.layout.fragment_campaign_analysis_report;
    }
