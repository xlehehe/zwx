 ...
 * version: 1.0
 **/
public class MemberInfoPerfectNewActivity extends BaseActivity<CampaignsContract.Presenter> implements CampaignsContract.View,View.OnClickListener  {
...
//    protected MoreTextView tvStoreNames;
    ...
    protected int getLayoutId() {
        return R.layout.activity_member_info_perfect;
    }
...
//                    edtEnd.setText(TimeUtils.date2String(TimeUtils.string2Date(endDate),new SimpleDateFormat("yyyy-MM-dd HH:mm")).replace("-","."));
        ...
        if("NEW".equals(compaignStatus)){
            ...
            presenter.doHyEdit(this,campaignId);
            edtName.setText(campaignName!=null?campaignName:"");
        }
        ...
        setBrandLogo();
        presenter.queryMemberInfoPerfectStoreList(this,userId,true,true);
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_select_shop:  //开始时间
                ...
                if(storeList != null && storeList.size()>0){
                    ...
                    presenter.queryMemberInfoPerfectStoreList(this,userId,false,true);
                }
            ...
            case R.id.btn_next: //下一步
                Intent intent = new Intent(MemberInfoPerfectNewActivity.this,MemberInfoPerfectNextTwoActivity.class);
                campaignName = edtName.getText().toString().trim();
                startDate = edtStart.getText().toString().trim();
                endDate = edtEnd.getText().toString().trim();
...
//                        myAdapter.notifyDataSetChanged();
    ...
    protected void setBrandLogo(){
        ...
        Glide.with(MemberInfoPerfectNewActivity.this).load(brandLogo).apply(requestOptions).into(ivBrand);
    }
