package com.zwx.scan.app.widget.dialog;
...
import com.zwx.scan.app.widget.dialog.listener.DialogAssigner;
...
import com.zwx.scan.app.widget.dialog.listener.TdataListener;
...
public class DialogUIUtils {
     ...
     * @return
     */
    public static BuildBean showCustomTranAlert(Context context, View contentView) {
        return showCustomTranAlert(context, contentView, Gravity.CENTER, true, true);
    }
     ...
     * @return
     */
    public static BuildBean showCustomTranAlert(Context context, View contentView, int gravity, boolean cancleable, boolean outsideTouchable) {
        return DialogAssigner.getInstance().assignCustomTranAlert(context, contentView, gravity, cancleable, outsideTouchable);
    }
    ...
    private static void showToast(String str, int showTime, int gravity) {
        ...
        if (gravity == Gravity.TOP) {
            if (mToastTop == null) {
                ...
                mToastTop.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.avatar_height_64));
            }
            mToast = mToastTop;
            mToast.setText(str);
            mToast.show();
            ...
            if (mToastBottom == null) {
                ...
                mToastBottom.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.avatar_height_64));
            }
            mToast = mToastBottom;
            mToast.setText(str);
            mToast.show();
