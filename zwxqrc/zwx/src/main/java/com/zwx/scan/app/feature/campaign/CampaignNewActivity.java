 ...
 * version: 1.0
 **/
public class CampaignNewActivity extends BaseActivity<CampaignsContract.Presenter> implements CampaignsContract.View,View.OnClickListener {
    ...
    @BindView(R.id.tv_select_store_title2)
    protected TextView tvSelectTitle2;
...
//    protected MoreTextView tvStoreNames;
    ...
    protected TextView edtStart;
    @BindView(R.id.ll_start)
    protected LinearLayout llStart;

    @BindView(R.id.tv_end_time)
    protected TextView edtEnd;
    ...
    protected static String storeIdCampaignType;
...
//    public  static   String campaignStoreSelectType;
    ...
    private Campaign copyCampaign = new Campaign();
    ...
    protected int getLayoutId() {
        return R.layout.activity_campaign_new;
    }
    ...
    protected void initView() {
        ...
        tvTitle.setText("转发活动基础设置");

        tvSelectTitle1.setVisibility(View.GONE);
        tvSelectTitle2.setVisibility(View.VISIBLE);
...
//                    edtEnd.setText(TimeUtils.date2String(TimeUtils.string2Date(endDate),new SimpleDateFormat("yyyy-MM-dd HH:mm")).replace("-","."));
                ...
                presenter.doEdit(this,campaignId);
...
//                tvStoreNames.setText("全部自营");
        ...
        setBrandLogo();
        presenter.queryBrandAndStoreList(this,userId,isCampaignAndCouponStore,true);
...
//                Toast.makeText(MyApplication.context, "非法字符！", Toast.LENGTH_SHORT).show();
       ...
       /* edtName.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    ...
                    KeyboardUtils.hideSoftInput(CampaignNewActivity.this,edtName);
                }
            }
        });*/
    }
    ...
    @OnClick({R.id.iv_back,R.id.tv_right,R.id.tv_select_shop,R.id.ll_start,R.id.ll_end,R.id.btn_next,
            R.id.iv_one,R.id.iv_two,R.id.iv_three,R.id.iv_four,R.id.iv_arrow})
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_right:
                ...
                campaignName = edtName.getText().toString().trim();
                startDate = edtStart.getText().toString().trim();
                endDate = edtEnd.getText().toString().trim();
                //复制并创建
                isCopyCreate = "NO";
                isEditCampaign = "NO";
                compaignStatus = "NEW";
...
//                campaignStoreSelectType = storeIdCampaignType;
            ...
            case R.id.btn_next: //下一步
                Intent intent = new Intent(CampaignNewActivity.this,CampaignNewNextTwoActivity.class);
                campaignName = edtName.getText().toString().trim();
                startDate = edtStart.getText().toString().trim();
                endDate = edtEnd.getText().toString().trim();

                campaign.setClient(2);
                campaign.setCampaignType("zf");
                campaign.setCompId(Long.parseLong(compId));
                campaign.setCampaignName(campaignName);
                campaign.setBeginDate(startDate!=null&&!"".equals(startDate)?startDate.replace(".","-")+":00":null);
                campaign.setEndDate(endDate!=null&&!"".equals(endDate)?endDate.replace(".","-")+":59":null);
                if("EDIT".equals(compaignStatus)){
                    campaign.setCreateUser("");
...
//                        myAdapter.notifyDataSetChanged();
    ...
    protected void setBrandLogo(){
        ...
        Glide.with(CampaignNewActivity.this).load(brandLogo).apply(requestOptions).into(ivBrand);
    }
        ...
        pvCustomTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                if(isStartDate){
                    ...
                    edtStart.setText(TimeUtils.date2String(date,new SimpleDateFormat("yyyy-MM-dd HH:mm")).replace("-","."));

                }else {
                    edtEnd.setText(TimeUtils.date2String(date,new SimpleDateFormat("yyyy-MM-dd HH:mm")).replace("-","."));
                }
