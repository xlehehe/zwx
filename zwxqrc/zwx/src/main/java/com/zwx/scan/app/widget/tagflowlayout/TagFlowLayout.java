...
import com.zwx.scan.app.widget.tagflowlayout.tags.MutSelectedTagView;
import com.zwx.scan.app.widget.tagflowlayout.view.FlowLayout;
...
//    private View divider_right;
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        minVisibleHeight = (int) a.getDimension(R.styleable.TagFlowLayout_minVisibleHeight, ScreenUtils.dip2px(mContext, DEFAULT_MIN_LAYOUT_HEIGHT));
        maxVisibleHeight = (int) a.getDimension(R.styleable.TagFlowLayout_maxVisibleHeight, ScreenUtils.dip2px(mContext, DEFAULT_MAX_LAYOUT_HEIGHT));
        tagsHorizontalSpace = (int) a.getDimension(R.styleable.TagFlowLayout_tagsHorizontalSpace, ScreenUtils.dip2px(mContext, DEFAULT_TAGS_SPACE));
        tagsVerticalSpace = (int) a.getDimension(R.styleable.TagFlowLayout_tagsVerticalSpace, ScreenUtils.dip2px(mContext, DEFAULT_TAGS_SPACE));
        indicateImage = a.getDrawable(R.styleable.TagFlowLayout_indicateImage);
        titleTextSize = a.getDimension(R.styleable.TagFlowLayout_titleTextSize, ScreenUtils.sp2px(mContext, DEFAULT_TITLE_TEXT_SIZE));
        hintTextSize = a.getDimension(R.styleable.TagFlowLayout_hintTextSize, ScreenUtils.sp2px(mContext, DEFAULT_HINT_TEXT_SIZE));
    ...
    private void initViews() {
        View.inflate(mContext, R.layout.layout_tag_flow_layout, this);
...
//        }
        if (start < 0) {
            start = mLayout.getMeasuredHeight();
        }
        if(end<0){
            end = mLayout.getMeasuredHeight();
        }
...
//        this.divider_left.setBackgroundColor(dividerColor);
//        this.divider_right.setBackgroundColor(dividerColor);
    }
    ...
    public void setMinVisibleHeight(int minVisibleHeight) {
        int minPx = ScreenUtils.dip2px(mContext, minVisibleHeight);
        if (!isFolded) {
    ...
    public void setMaxVisibleHeight(int maxVisibleHeight) {
        int maxPx = ScreenUtils.dip2px(mContext, maxVisibleHeight);
        if (isFolded) {
    ...
    public void setTitleTextSize(float titleTextSize) {
        this.titleTextSize = ScreenUtils.sp2px(mContext, titleTextSize);
    ...
    public void setHintTextSize(float hintTextSize) {
        this.hintTextSize = ScreenUtils.sp2px(mContext, hintTextSize);
    ...
    public void setForceFixed(boolean fixed) {
        hsv_tag_content.setForceFixed(fixed);
    }
