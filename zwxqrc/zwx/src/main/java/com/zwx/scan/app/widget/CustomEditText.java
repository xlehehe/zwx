...
public class CustomEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (rightDrawable == null) {
            ...
            rightDrawable = getResources().getDrawable(R.drawable.ic_clear);
        }
