 ...
 */
public class CampaignChartFragment extends BaseFragment {
    ...
    public CampaignChartFragment() {
        // Required empty public constructor
    }

    public static CampaignChartFragment getInstance(String chartTitle, String dateStr, List<Map<String, Object>> dataList) {
        CampaignChartFragment chartFragment = new CampaignChartFragment();
    ...
    protected int getlayoutId() {
        return R.layout.fragment_campaign_chart;
    }
...
//        XYMarkerView mv = new XYMarkerView(getActivity(), xAxisFormatter);
        ...
        chart.setMarker(mv);
        chart.invalidate();
        leftAxis.setAxisMaximum(chart.getAxisLeft().getAxisMaximum()+10);
