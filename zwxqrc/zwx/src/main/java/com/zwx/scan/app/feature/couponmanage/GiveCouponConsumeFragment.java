...
public class GiveCouponConsumeFragment extends BaseFragment implements View.OnClickListener{
    ...
    public GiveCouponConsumeFragment() {
    }

    public static Fragment getInstance(Coupon coupon,String prizeName) {
        GiveCouponConsumeFragment fragment = new GiveCouponConsumeFragment();
...
//                .bitmapTransform(roundedCorners)
            ...
            Glide.with(getActivity()).load(bgPath).apply(requestOptions2).into(ivAvatar);
            ...
            case  R.id.ll_delete:
                ...
                if("条件一".equals(prizeName)){
                    ...
                    if(activity.couponList1 != null && activity.couponList1.size()>0){
                        ...
                        //同时删除优惠券列表页面
                        ((GiveCouponNextConsumeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList1,prizeName);
                    ...
                    if(activity.couponList2 != null && activity.couponList2.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((GiveCouponNextConsumeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList2,prizeName);
                    ...
                    if(activity.couponList3 != null && activity.couponList3.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((GiveCouponNextConsumeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList3,prizeName);
                    ...
                    if(activity.couponList4 != null && activity.couponList4.size()>0){
                        ...
                        CampaignCouponListFragment.selectCoupons.clear();
                        //同时删除优惠券列表页面
                        ((GiveCouponNextConsumeTwoFragment) (this.getParentFragment())).chanageLayout(activity.couponList4,prizeName);
