...
import com.zwx.library.utils.ConvertUtils;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#F73B54"); //FB4846
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, ConvertUtils.dp2px(0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = ConvertUtils.dp2px(DEF_DRAW_SIZE);
