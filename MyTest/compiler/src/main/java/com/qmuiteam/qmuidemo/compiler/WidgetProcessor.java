...
public class WidgetProcessor extends AbstractProcessor {
    ...
    private final String mPackageName = "com.zwx.instalment.app.manager";

    ClassName mMapName = ClassName.get("java.util", "Map");
    ClassName mHashMapName = ClassName.get("java.util", "HashMap");
    ClassName mItemDescName = ClassName.get("com.zwx.instalment.app.model", "QDItemDescription");
    ClassName mBaseFragmentName = ClassName.get("com.zwx.instalment.app.base", "BaseQMUIFragment");
