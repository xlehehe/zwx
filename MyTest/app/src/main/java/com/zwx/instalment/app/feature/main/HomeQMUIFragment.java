...
import com.zwx.instalment.app.feature.fragment.home.HomeComponentsController;
import com.zwx.instalment.app.feature.fragment.home.HomeController;
import com.zwx.instalment.app.feature.fragment.home.HomeLabController;
import com.zwx.instalment.app.feature.fragment.home.HomeUtilController;
 ...
 */
public class HomeQMUIFragment extends BaseQMUIFragment {

    private final static String TAG = HomeQMUIFragment.class.getSimpleName();
...
//        );
    ...
    private void initPagers() {
        ...
        HomeController.HomeControlListener listener = new HomeController.HomeControlListener() {
            @Override
            public void startFragment(BaseQMUIFragment fragment) {
                HomeQMUIFragment.this.startFragment(fragment);
            }
        };
