...
//        mTabWidth = ScreenUtils.getScreenWidth(context)/3;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public float getTabScreeWidth() {
        return tabScreeWidth;
    }

    public void setTabScreeWidth(float tabScreeWidth) {
        this.tabScreeWidth = tabScreeWidth;
    }
