...
package com.zwx.instalment.app.manager;

import com.zwx.instalment.app.base.BaseQMUIFragment;
import com.zwx.instalment.app.feature.fragment.components.QDButtonFragment;
...
public class QDDataManager {
    ...
    private List<Class<? extends BaseQMUIFragment>> mComponentsNames;
    private List<Class<? extends BaseQMUIFragment>> mUtilNames;
    private List<Class<? extends BaseQMUIFragment>> mLabNames;
 ...
 /*       mComponentsNames.add(QDDialogFragment.class);
    ...
    private void initUtilDesc() {
        ...
        mUtilNames.add(QDButtonFragment.class);
...
//        mUtilNames.add(QDNotchHelperFragment.class);
    ...
    private void initLabDesc() {
        ...
        mLabNames.add(QDButtonFragment.class);
    ...
    public QDItemDescription getDescription(Class<? extends BaseQMUIFragment> cls) {
        return mWidgetContainer.get(cls);
    }

    public String getName(Class<? extends BaseQMUIFragment> cls) {
    ...
    public String getDocUrl(Class<? extends BaseQMUIFragment> cls) {
        QDItemDescription itemDescription = getDescription(cls);
        if (itemDescription == null) {
            return null;
        }
