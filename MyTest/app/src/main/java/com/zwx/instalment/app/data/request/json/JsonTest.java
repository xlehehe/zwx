...
public class JsonTest {
    ...
    public static void main(String[] args) {
        ...
        responseString = FromJsonUtils.fromJson(responseString, BaseDataResponse.class).toString();
        System.out.println("反序列化后responseString：" + responseString);
        System.out.print("***********************************************************" + "\n");
        
        System.out.print("mJson1：" + mJson1);
        BaseDataResponse<DataBean> mData1 = FromJsonUtils.fromJson(mJson1, DataBean.class);
        System.out.print("数据类型：" + mData1.getDataType() + "\t解析后取值：" + mData1.getData().getName() + "\n");
        System.out.print("====================================" + "\n");

        BaseDataResponse<DataBean> mData2 = FromJsonUtils.fromJson(mJson2, DataBean.class);
        System.out.print("数据类型：" + mData2.getDataType() + "\t解析后取值：" + mData2.getData().getName() + "\n");
        System.out.print("====================================" + "\n");

        BaseDataResponse<DataBean> mData3 = FromJsonUtils.fromJson(mJson3, DataBean.class);
        System.out.print("数据类型：" + mData3.getDataType() + "\t解析后取值：" + mData3.getData().getName() + "\n");
        System.out.print("====================================" + "\n");

        BaseDataResponse<List<DataBean>> mData4 = FromJsonUtils.fromJson(mJson4, DataBean.class);
        for (DataBean mData : mData4.getData()) {
            System.out.print("数据类型：" + mData4.getDataType() + "\t解析后取值：" + mData.getName() + "\n");
        }
        System.out.print("====================================" + "\n");

        BaseDataResponse<ActivityBean> mData5 = FromJsonUtils.fromJson(mJson5, ActivityBean.class);
        System.out.print("数据类型：" + mData5.getDataType() + "\t解析后取值：" + mData5.getData().getTitle() + "\n");
        System.out.print("====================================" + "\n");

        BaseDataResponse<List<ActivityBean>> mData6 = FromJsonUtils.fromJson(mJson6, ActivityBean.class);
