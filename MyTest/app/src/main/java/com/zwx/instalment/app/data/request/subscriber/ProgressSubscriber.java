package com.zwx.instalment.app.data.request.subscriber;

import android.content.Context;

import com.zwx.instalment.app.data.request.interfaces.SubscriberOnNextListener;
import com.zwx.instalment.app.data.request.progress.ProgressCancelListener;
...
//      Toast.makeText(context,"返回值错误ProgressSubscriber onError:" + ExceptionEngine.handleException(e).getMessage(),
//              Toast.LENGTH_LONG,Toast.ERROR,false).show();
