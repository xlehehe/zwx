package com.zwx.instalment.app.widget.tablayout;
...
import com.zwx.instalment.app.utils.ScreenUtils;
import com.zwx.instalment.app.widget.tablayout.listener.OnTabSelectListener;
import com.zwx.instalment.app.widget.tablayout.utils.FragmentChangeManager;
import com.zwx.instalment.app.widget.tablayout.utils.UnreadMsgUtils;
import com.zwx.instalment.app.widget.tablayout.widget.MsgView;
 ...
 * author : lizhilong
 * time   : 2018/09/03
 * desc   : 自定义tab菜单，没有继承HorizontalScrollView不能滑动,
 *          对于ViewPager无依赖,用于界面顶部
 * version: 1.0
 **/
...
//        mTabWidth = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_width, dp2px(-1));
        mTabWidth = ScreenUtils.getScreenWidth(context)/2;
